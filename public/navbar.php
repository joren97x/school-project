...
<nav class="navbar bg-dark" data-bs-theme="dark">
            <div class="col-9">
                <button class="btn btn-white" href="#offcanvasExample" aria-controls="offcanvasExample" data-bs-toggle="offcanvas"><i class="bi bi-list h1 text-white"></i></button>
            ...
            <?php
                if(isset($_SESSION['userType'])){
                    ...
                    ?>
                        ...
                        <div class="col-3" >
                            <a href="index.php" class="mx-2 text-white" style="text-decoration: none">Home</a>
                            <a href="about.php" class="mx-2 text-white" style="text-decoration: none">About</a>
                            <a href="login.php" class="mx-2 text-white" style="text-decoration: none">Login</a>
                            <a href="login.php" class="mx-2 text-white" style="text-decoration: none">Signup</a>
                        </div>
        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
            ...
            <?php if(isset($_SESSION['userType'])) {if($_SESSION['userType'] == "admin") {?><i class="bi bi-house-add h3 mx-2"></i><a href="houseManagement.php" style="text-decoration: none;color: black;">Guest House Management</a><br><?php }} ?>
